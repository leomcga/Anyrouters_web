...
type Midjourney struct {
	Id                      int     `json:"id"`
	RequestId               *string `json:"request_id,omitempty" gorm:"type:varchar(64);uniqueIndex:idx_midjourneys_request_id"`
	BillingRequestId        *int64  `json:"billing_request_id,omitempty" gorm:"uniqueIndex:idx_midjourneys_billing_request_id"`
	...
	LockedUntil             int64   `json:"-" gorm:"type:bigint;not null;default:0;index:idx_midjourneys_locked_until"`
