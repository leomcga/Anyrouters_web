...
type MutableStrandsProps = Required<Omit<StrandsProps, 'className' | 'style'>>
...
export default function Strands({
  ...
  const propsRef = useRef<MutableStrandsProps>({
    colors,
    count,
    speed,
    amplitude,
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (import.meta.env.DEV) {
        ...
        console.error('Failed to initialize Strands WebGL background:', error)
      }
      return undefined
    }
